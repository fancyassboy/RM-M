		...
		<section class = "container-fluid">
			...
			<div class = "row">
				<div class = "col-md-12">
					...
					<h3 class="hh3" style='text-align:center;'>Informācijas atspoguļošana</h3>
		        	<form action = "1var.php" method = "post">
						<div class = "virsraksti">Izvēlieties:</div>
							<select class="selectpicker" name='programmas'>
								<option value = 'visi ieraksti' selected>Visi ieraksti</option>
									<?php priek() ?>

							</select><input type = "submit" name = "sutit2" value = "Apstiprināt"/>
						</br>
							<?php
